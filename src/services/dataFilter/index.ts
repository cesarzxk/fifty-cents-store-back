...
export default function dataFilter(
    ...
    const productsFiltred = newData.filter((item)=>{
        ...
        if(isCategoryInFilters == true && isMaterialInFilters==true && isSearched==true){
            return true;
        }else if(isCategoryInFilters == true && isMaterialInFilters==true){
            return true;
        }else if (isCategoryInFilters==true && isMaterialInFilters==undefined ){
            return true;
        }else if (isCategoryInFilters==undefined && isMaterialInFilters==true){
            return true;
        }else{
            return false;
        }
